def leer_estudiantes():
    """Lee el archivo estudiantes.txt y devuelve una lista de estudiantes"""
    try:
...
def generar_reporte(estudiantes):
    """Genera el archivo reporte.txt con el reporte completo"""
    try:
...
def agregar_estudiante():
    """Permite al usuario agregar un nuevo estudiante"""
    try:
